...
%%
\thispagestyle{headings}
\markright{Results\hfill Step 1: FDR \hfill}
...
\thispagestyle{headings}
\markright{Results\hfill Step 2: Bonferroni \hfill}
...
{\captionsetup{labelformat=empty}    \caption{A volcano plot of 20 candidate genes in TCGA HNSCC.
