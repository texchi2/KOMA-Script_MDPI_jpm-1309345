...
\begin{flushright}
  ...
  \vfill
\end{flushright}
Chi, L.-H., Wu, A. T. H., Hsiao, M. \& Li, Y.-C. (Jack). A Transcriptomic Analysis of Head and Neck Squamous Cell Carcinomas for Prognostic Indications. J. Pers. Med. 11, 782 (2021).
%\cite{Chi2021}
...
\begin{outline}
\1 A model with biomarker estimates %(Figure \ref{fig:figure1})
...
the mind--brain--body axis

\begin{outline}
\1 a stressful environment %(giant \textcolor{black}{black} arrow) 
...
\1 carcinogenesis with help from known carcinogens
\end{outline}
...
\1 therapeutic relationship (TR), the physicians' spiritual properties (empathy, sympathy, and compassion) will engage cancer patients
\1 self-compassion to gain resilience against the disease through their mind--brain--body axis
...
\begin{outline}
\1 Three biomarker candidates---CAMK2N1, CALML5, and FCGBP---which are all heavily associated with the prognosis of \acrshort{os}.
\1 The microenvironment of HNSCC, influenced by the mind--brain--body axis, requires further exploration and understanding using holistic multi-parametric approaches.
\1 The patients trust those who take care of them and have the confidence to increase the capacity to recover from diseases through a mind--brain--body connection manner
\1 The \acrshort{tcga} might collect those "holistic features" for further study of personalized medicine.
\1 Since mindfulness meditation will be helpful in cancer healthcare, we continually educate our cancer patients that they should confess for not taking care of their bodies and spirits in the past, and give sincere thanks for their physical body's hard work.
\end{outline}
