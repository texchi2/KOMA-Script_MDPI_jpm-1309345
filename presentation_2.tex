...
\newcommand*{\mytitle}{ELP-IS} % Title
\newcommand*{\runninghead}{IS Letenky} % Running head displayed on almost all slides
\newcommand*{\myauthor}{Jiří Sekerka} % Presenters name(s)
\newcommand*{\mydate}{\today} % Presentation date
\newcommand*{\myuni}{SEK0026 VŠB} % University or department
